...
```bash
ros2 launch gxu2026_robot_description robot_description_launch.py
```
...
xmacro4sdf src/gxu2026_robot_description/resource/xmacro/simulation_robot.sdf.xmacro > src/gxu2026_robot_description/resource/xmacro/simulation_robot.sdf
```
...
- `robot_name` (str, default: "simulation_robot")
    ...
    机器人 XMacro 描述文件的**名字（无需后缀）**。描述文件应位于 `package://gxu2026_robot_description/resource/xmacro` 目录下。
