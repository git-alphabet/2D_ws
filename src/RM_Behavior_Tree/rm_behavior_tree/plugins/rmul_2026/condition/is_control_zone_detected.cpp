#include "rm_behavior_tree/plugins/rmul_2026/condition/is_control_zone_detected.hpp"
...
{
  auto res = getInput<sp_msgs::msg::RMUL>("rfid_status");
  if (!res) {
