...
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::BidirectionalPort<double>("fortress_enemy_x"), BT::BidirectionalPort<double>("fortress_enemy_y"),
      ...
      BT::BidirectionalPort<double>("supply_zone_radius"),
      BT::BidirectionalPort<double>("patrol_arrive_radius"),
      ...
      BT::BidirectionalPort<int>("ammo_increase_interval_ms"),
