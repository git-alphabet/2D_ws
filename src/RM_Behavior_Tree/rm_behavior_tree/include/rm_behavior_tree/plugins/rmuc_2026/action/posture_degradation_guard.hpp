...
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::InputPort<bool>("nav_goal_valid", false, "当前导航目标是否有效"),
      BT::InputPort<double>("pose_x", 0.0, "当前机器人 x"),
      BT::InputPort<double>("pose_y", 0.0, "当前机器人 y"),
      BT::InputPort<double>("nav_goal_x", 0.0, "当前实际导航目标 x"),
      BT::InputPort<double>("nav_goal_y", 0.0, "当前实际导航目标 y"),
      BT::InputPort<double>("fortress_area_x", 0.0, "堡垒区 x"),
      BT::InputPort<double>("fortress_area_y", 0.0, "堡垒区 y"),
      BT::InputPort<double>("arrive_radius", 0.5, "到达判定半径"),
